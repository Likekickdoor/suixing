...
class messageHtml {
    ...
    public static function leaveDisplay($message){
        foreach($message as $value){
            ...
            <div class="tuo">
                ...
                <input class="hui" type="button" value="查看" id='<?php echo $value['id']?>'/>
     ...
     * 输出留言城市查询喜好数据分析
     */
    public static function select_like($message){
        foreach($message as $value){
            ?>
<tr>
    <td class="t1">
    ...
    <td class="t2"><?php echo $value['city'];?></td>
    <td class="t1"><?php echo $value['start_city'];?></td>
    <td class="t2"><?php echo $value['toCity'];?></td>
    <td class="t1"><?php echo $value['num'];?></td>
